...
function Header() {
  return (
    <div>
<section className='w-full h-14 p-4 flex gap-15 md:gap-150  bg-white shadow-lg fixed items-center'>
<div>
...
<nav className='md:text-md   text-sm font-semibold text-gray-700 flex gap-3 md:gap-15'>
